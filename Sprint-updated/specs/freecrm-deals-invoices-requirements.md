...
Each case must contain a clear precondition, test condition, numbered steps, test data, expected result, requirement reference, priority, and execution fields. The final workbook must contain fewer than 16 data rows.
