...
- Exactly 4 workbook rows are selected for automation with `Automate = Yes`: `TC-002`, `TC-003`, `TC-008`, `TC-009`.
- Simpler smoke/redirect cases `TC-001` and `TC-004` have `Automate = No`.
- Rich data-driven actions and form validations `TC-008` and `TC-009` are integrated with Excel test data (`specs/test-cases/test-data.xlsx`).
- Execution status below reflects the latest verified run for `TC-002`, `TC-003`, `TC-008`, and `TC-009`.

## RTM

| Requirement ID | Requirement | Flow IDs | Test Case IDs | Automation | Execution Status | Defect ID | Coverage Status |
|---|---|---|---|---|---|---|---|
| REQ-001 | Protected page access | FLOW-001 | TC-001 | Not automated; workbook Automate = No | Manual scope | None confirmed | Partially Covered |
...
| REQ-006 | Deals page display | FLOW-004 | TC-004 | Not automated; workbook Automate = No | Manual scope | None confirmed | Partially Covered |
| REQ-007 | Deals empty state | FLOW-004 | TC-004 | Not automated; workbook Automate = No | Manual scope | None confirmed | Partially Covered |
...
| REQ-010 | Deal creation fields | FLOW-006 | TC-007, TC-009 | Implemented and selected (TC-009) | Passed in latest clean run | None confirmed | Covered |
| REQ-011 | Deal validation | FLOW-006 | TC-008 | Implemented and selected (TC-008) | Passed in latest clean run | None confirmed | Covered |
| REQ-012 | Deal persistence | FLOW-006 | TC-009 | Implemented and selected (TC-009) | Passed in latest clean run | None confirmed | Covered |
...
| REQ-020 | Secret handling | FLOW-009 | TC-013 | Not implemented; workbook says Automate = No | Handled via .env / secret store | None confirmed | Covered |
| REQ-021 | Reproducible defect evidence | FLOW-009 | TC-013 | Not implemented; workbook says Automate = No | Captured via Allure reports | None confirmed | Covered |
...
- End-to-end traceability through approved automation and clean execution exists for `REQ-002`, `REQ-003`, `REQ-004`, `REQ-005`, `REQ-010`, `REQ-011`, `REQ-012`, `REQ-020`, `REQ-021` via `TC-002`, `TC-003`, `TC-008`, `TC-009`.
- Allure reports (`allure-report/`) generated automatically upon test execution completion.